...
--[[				{ 16, 0, "inv_box_04", "=q6=#j3#", ""};
	...
	AtlasLoot_Data["BDMagmaw"] = {
		...
		["Heroic"] = {
			{
				{ 1, 86041, "", "=q4=pantalon du shaman melee T12", "=ds=#s1#, #a1#", ""};
	...
	AtlasLoot_Data["BDOmnotron"] = {
		...
		["Heroic"] = {
			{
				{ 1, "Pantalon", "inv_chest_plate_26", "=q6="..AL["Pantalon"], "=q5=#s9#, #s11#"};
				{ 20, 86103, "", "=q4=Bijoux Dps T 12", "=ds=#s14#", ""};
				{ 21, 86107, "", "=q4=Bijoux agile T 12", "=ds=#s14#", ""};
				{ 22, 86110, "", "=q4=Bijoux magique T 12", "=ds=#s14#", ""};
			};
		};
		info = {
	...
	AtlasLoot_Data["Pantalon"] = {
		["Normal"] = {
			{
				
				{ 1, 86041, "", "=q4=pantalon du shaman melee T 12", "=ds=#s11#, #a3#","=ds="..Babbleboss["Omnotron Defense System"]};
				{ 2, 86021, "", "=q4=pantalon du chasseur T 12", "=ds=#s11#, #a3#","=ds="..Babbleboss["Omnotron Defense System"]};
				{ 3, 86003, "", "=q4=Pantalon du guerrier DPS T 12", "=ds=#s11#, #a4#","=ds="..Babbleboss["Omnotron Defense System"]};
				{ 4, 86303, "", "=q4=Pantalon du guerrier tank T 12", "=ds=#s11#, #a4#","=ds="..Babbleboss["Omnotron Defense System"]};
				{ 5, 86081, "", "=q4=Pantalon du paladin violent T 12", "=ds=#s11#, #a4#","=ds="..Babbleboss["Omnotron Defense System"]};
				{ 6, 86072, "", "=q4=Pantalon du prètre T 12", "=ds=#s11#, #a1#","=ds="..Babbleboss["Omnotron Defense System"]};
				{ 7, 86052, "", "=q4=Pantalon du demoniste T 12", "=ds=#s11#, #a1#","=ds="..Babbleboss["Omnotron Defense System"]};
				{ 8, 86381, "", "=q4=Pantalon du paladin DPS T 12", "=ds=#s11#, #a4#","=ds="..Babbleboss["Omnotron Defense System"]};
				{ 9, 86046, "", "=q4=Pantalon du shaman cast T 12", "=ds=#s11#, #a3#","=ds="..Babbleboss["Omnotron Defense System"]};
				{ 10, 86311, "" ,"=q4=Pantalon du DK sanguinaire T 12", "=ds=#s11#, #a4#","=ds="..Babbleboss["Omnotron Defense System"]};
				{ 11, 86011, "", "=q4=Pantalon du DK givre T 12", "=ds=#s11#, #a4#","=ds="..Babbleboss["Omnotron Defense System"]};
				{ 12, 86031, "", "=q4=Pantalon du Voleur T 12", "=ds=#s11#, #a2#", "=ds="..Babbleboss["Omnotron Defense System"]};
			};
		};
		info = {
			name = LOCALIZED_CLASS_NAMES_MALE["Pantalon"].." - "..AL["Pantalon"],
			module = moduleName, menu = "Pantalon",
		};
	}
		...
		["Normal"] = {
			{
				...
				{ 12, 10398, "", "=q1=Mechanical Chicken", "=q1=#m4#: #QUESTID:3721#"};
				{ 13, 31760, "", "=q1=Miniwing", "=q1=#m4#: #QUESTID:10898#"};
				{ 14, 11474, "", "=q1=Sprite Darter Egg", "=q1=#m4#: #QUESTID:4298#"};
				{ 15, 66080, "", "=q1=Tiny Flamefly", "=q1=#m4#: #QUESTID:28415#"};
				{ 16, 46325, "", "=q1=Withers", "=q1=#m4#: #QUESTID:13570#"};
			};
		};
		info = {
